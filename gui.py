...
class GraphicTest:
    def __init__(self):
        ...
        pygame.init()
        self.image_open = pygame.image.load('background.jpg')
        self.image_open = pygame.transform.scale(self.image_open, (self.w,self.h))

        self.bg = pygame.image.load('background_game.jpg')
    ...
    def reset_game(self):
        ...
        self.draw_text(self.screen, message, self.h / 10, 70,self.color_heading)  
        
        pygame.draw.rect(self.screen,(255,192,25), (50,250,650,50), 2)

        self.draw_text(self.screen, self.word, self.h / 3, 28, self.color_text)
